...
LUA_BASE_FILES = bspline.lua fft-init.lua integ-init.lua template.lua check.lua \
	...
	lm-helpers.lua algorithm.lua monomial.lua linfit_rank.lua matrix-power.lua cblas.lua
...
LUA_TEMPLATES = gauss-kronrod-x-wgs qag rk8pd lmfit qng rkf45 ode-defs rk4 sf-defs vegas-defs rnd-defs rk8pd-vec rkf45-vec
