...
return {
   ...
   taus       = rng_test('taus', 1, 10000, 2733957125), -- UL
   taus2      = rng_test('taus2', 1, 10000, 2733957125), -- UL
   taus113    = rng_test('taus113', 1, 1000, 1925420673), -- UL
   transputer = rng_test('transputer', 1, 10000, 1244127297), -- UL
   vax        = rng_test('vax', 1, 10000, 3051034865), -- UL

  --  Borosh13 test value from PARI: (1812433253^10000)%(2^32)
  borosh13 = rng_test('borosh13', 1, 10000, 2513433025), -- UL

  --  Fishman18 test value from PARI: (62089911^10000)%(2^31-1)
  fishman18 = rng_test('fishman18', 1, 10000, 330402013), -- UL

  -- Fishman2x test value from PARI:
  -- ((48271^10000)%(2^31-1) - (40692^10000)%(2^31-249))%(2^31-1)
  fishman2x = rng_test('fishman2x', 1, 10000, 540133597), -- UL

  -- Knuthran2 test value from PARI:
  --     { xn1=1; xn2=1; for (n=1,10000,
  --            xn = (271828183*xn1 - 314159269*xn2)%(2^31-1);
  --            xn2=xn1; xn1=xn; print(xn); ) }
  knuthran2 = rng_test('knuthran2', 1, 10000, 1084477620), -- UL
  ...
  lecuyer21 = rng_test('lecuyer21', 1, 10000, 2006618587), -- UL

  --  Waterman14 test value from PARI: (1566083941^10000)%(2^32)
  waterman14 = rng_test('waterman14', 1, 10000, 3776680385), -- UL
  ...
  coveyou = rng_test('coveyou', 6, 10000, 1416754246), -- UL

  --  Fishman20 test value from PARI: (6*48271^10000)%(2^31-1)
  fishman20 = rng_test('fishman20', 6, 10000, 248127575), -- UL
  ...
  ranlxd1 = rng_test('ranlxd1', 1, 10000, 1998227290), -- UL
  --  0.465248546261094020 * ldexp(1.0,32)

  ranlxd2 = rng_test('ranlxd2', 1, 10000, 3949287736), -- UL
  ...
  tt800 = rng_test('tt800', 0, 10000, 2856609219), -- UL
  ...
  rand48_1 = rng_test('rand48', 0, 10000, 0xDE095043), --UL
  rand48_2 = rng_test('rand48', 1, 10000, 0xEDA54977), --UL

  ranf_1 = rng_test('ranf', 0, 10000, 2152890433), --UL
